        ...
        tinymce.create('tinymce.plugins.ResizeToContainer', {
                init : function(ed, url) {
                        ...
                        function resize() {
                        		...
                        		if (iframe)
                        		{
                        			if ($(iframe.parentNode.parentNode.childNodes[0]).find('button').sort(function(a,b){var ha = $(a).height();var hb = $(b).height();if (ha > hb) return 1; if (ha < hb) return -1; return 0}).height() != 20)
                            		{
