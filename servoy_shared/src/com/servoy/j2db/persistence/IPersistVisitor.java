 ...
 */
public interface IPersistVisitor
{
	/**
	...
	/**
	 * Value to return to continue a traversal but don't go deeper into it the tree
	 */
	public static final Object CONTINUE_TRAVERSAL_BUT_DONT_GO_DEEPER = new Object();

	/**
	 * Value to return to continue a traversal but don't go up to the parent
	 */
	public static final Object CONTINUE_TRAVERSAL_BUT_DONT_GO_UP = new Object();

	/**
	 * @returns continueTraversal
	 */
