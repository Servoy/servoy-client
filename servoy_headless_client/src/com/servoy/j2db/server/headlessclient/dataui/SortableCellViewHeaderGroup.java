...
public class SortableCellViewHeaderGroup extends Model implements IComponentAssignedModel
{
	...
	public SortableCellViewHeaderGroup(final PageableListView listView, AbstractBase cellview)
	{
		this.listView = listView;
		this.cellview = cellview;
	}

	public void add(String name, boolean dir)
	{
		sorted.put(name, new Boolean(dir));
	}
	...
	protected final void sort(final String name, final WebCellBasedView view, int modifiers)
	{
		...
		try
		{
			...
			while (it.hasNext())
			{
				...
				{
					if (name.equals(ComponentFactory.getWebID(element)))
					{
