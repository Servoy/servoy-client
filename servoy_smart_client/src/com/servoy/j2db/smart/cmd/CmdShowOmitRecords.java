 ...
 * @author jblok
 */
public class CmdShowOmitRecords extends AbstractCmd
{
/*
 ...
 */
	public CmdShowOmitRecords(ISmartClientApplication app)
	{
		super(
			app,
			"CmdShowOmitRecords", app.getI18NMessage("servoy.menuitem.showOmitted"), "servoy.menuitem.showOmitted", app.getI18NMessage("servoy.menuitem.showOmitted.mnemonic").charAt(0)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	}
 ...
 */
	...
	public UndoableEdit doIt(java.util.EventObject ae)
	{
		try
		{
			application.blockGUI(application.getI18NMessage("servoy.menuitem.showOmitted.status.text")); //$NON-NLS-1$
