 ...
 */
	public CmdCut(ISmartClientApplication app)
	{
		super(
			app,
			"CmdCut", app.getI18NMessage("servoy.menuitem.cut"), "servoy.menuitem.cut", app.getI18NMessage("servoy.menuitem.cut.mnemonic").charAt(0), app.loadImage("cut.gif")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
		setActionCommand("cut"); //$NON-NLS-1$
		setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, J2DBClient.menuShortcutKeyMask));
	}
