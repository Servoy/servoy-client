...
/**
 * Select statement wrapper: select count(*) from <query>.
 *
 * @author rgansevles
 */
public final class QuerySelectCountFrom implements ISQLSelect
{
	...
	public QuerySelectCountFrom(ISQLSelect select, String name, boolean distinctCount)
	{
		this.select = select;
		this.name = name;
	...
	public int hashCode()
	{
		...
		result = prime * result + (distinctCount ? 1231 : 1237);
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		QuerySelectCountFrom other = (QuerySelectCountFrom)obj;
		if (name == null)
		{
	...
	{
		return new StringBuffer("SELECT COUNT(").append(distinctCount ? "DISTINCT" : "").append(") FROM <").append(select).append("> ").append(name)
			.toString();
	}
