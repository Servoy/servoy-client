 ...
 * @author jblok
 */
public class CmdOmitRecord extends AbstractCmd
{
/*
 ...
 */
	public CmdOmitRecord(ISmartClientApplication app)
	{
		super(
			app,
			"CmdOmitRecord", app.getI18NMessage("servoy.menuitem.omitRecord"), "servoy.menuitem.omitRecord", app.getI18NMessage("servoy.menuitem.omitRecord.mnemonic").charAt(0)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	}
 ...
 */
	...
	public UndoableEdit doIt(java.util.EventObject ae)
	{
		try
		{
			application.blockGUI(application.getI18NMessage("servoy.menuitem.omitRecord.status.text")); //$NON-NLS-1$
