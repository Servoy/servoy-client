{
	...
	"model":
	{
		...
		"responsivePageSize": { "type": "int", "tags": {"doc" : "This property sets the number of cells this component will generate when this component is placed in a responsive form; ignored in absolute."}},
