...
describe('svyTabpanel component', function() {
    var $scope 
    var $compile  
	var $httpBackend 
	var $timeout
	...
	beforeEach(function(){		
	  module('svyTemplates')  // generated by ngHtml2JsPreprocessor from all .html template files , as strings in the svyTemplate module
