...
public interface IExecutingEnviroment
{
	...
	public final static String TOPLEVEL_JSVALUELIST = "JSValueList"; //$NON-NLS-1$
	public final static String TOPLEVEL_JSFORM = "JSForm"; //$NON-NLS-1$
	public final static String TOPLEVEL_JSWEBCOMPONENT = "JSWebComponent"; //$NON-NLS-1$
	...
	public final static String[] TOPLEVEL_KEYWORDS = { TOPLEVEL_HISTORY, TOPLEVEL_PLUGINS, TOPLEVEL_APPLICATION, TOPLEVEL_EVENTS_MANAGER, TOPLEVEL_UTILS, TOPLEVEL_CLIENTUTILS, //
		TOPLEVEL_SECURITY, TOPLEVEL_DATABASE_MANAGER, TOPLEVEL_I18N, TOPLEVEL_SERVOY_EXCEPTION, TOPLEVEL_FORMS, TOPLEVEL_JSUNIT, TOPLEVEL_SCOPES, TOPLEVEL_MENUS, TOPLEVEL_JSVALUELIST, //
		TOPLEVEL_JSFORM, TOPLEVEL_JSWEBCOMPONENT, TOPLEVEL_JSPERMISSION, TOPLEVEL_EVENTS_MANAGER };
