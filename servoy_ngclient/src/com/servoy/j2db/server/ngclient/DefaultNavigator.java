...
{
	public final static String BEAN_CLASSNAME = "servoydefault:svy-navigator";
	...
	{
		super(null, 0, null);
		setBeanXML("{" + MAXINDEX_PROP + ":0," + CURRENTINDEX_PROP + ":0," + SETELECTEDINDEX_FUNCTION_NAME + ":'" + UUID.randomUUID() + "'}");
