...
.factory("$foundsetManager",function($sabloApplication) {
	return {
		getFoundSet: function(foundsethash, dataproviders) {
			return $sabloApplication.callService("$foundsetService", "getFoundSet", {foundsethash: foundsethash, dataproviders: dataproviders}, false);
		},
