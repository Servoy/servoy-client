angular.module('servoydefaultListbox', [ 'servoy' ]).run([ "$templateCache", "$http", function($templateCache, $http) {
...
} ]).directive('servoydefaultListbox', [ '$parse', '$templateCache', '$compile', '$apifunctions', '$sabloConstants', '$svyProperties', '$scrollbarConstants', function($parse, $templateCache, $compile, $apifunctions, $sabloConstants, $svyProperties, $scrollbarConstants) {
	return {
		restrict : 'E',
		scope : {
			model : "=svyModel",
