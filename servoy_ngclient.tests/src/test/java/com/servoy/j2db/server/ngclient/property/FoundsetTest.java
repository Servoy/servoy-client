...
public class FoundsetTest extends AbstractSolutionTest
{
	...
	public void foundsetRelated() throws JSONException// change selected index in main foundset and related foundset should change
	{
		...
		assertEquals(format(
			"{\"upd_serverSize\":12,\"upd_foundsetId\":%d,\"upd_sortColumns\":\"\",\"upd_selectedRowIndexes\":[0],\"upd_viewPort\":{\"startIndex\":1,\"size\":1,\"rows\":[{\"_svyRowId\":\"1.2;\",\"dp1\":\"relatedvalue121\",\"dp2\":\"relatedvalue122\"}]}}",
	...
	public void largeFoundsetUsage() throws JSONException
	{
		...
		assertTrue(new JSONObject(
			"{\"serverSize\":200,\"foundsetId\":1,\"sortColumns\":\"\",\"selectedRowIndexes\":[0],\"multiSelect\":false,\"findMode\":false,\"hasMoreRows\":true,\"viewPort\":{\"startIndex\":0,\"size\":1,\"rows\":[{\"_svyRowId\":\"1.0;\",\"lastname\":\"value01\",\"firstname\":\"value00\"}]}}")
				.similar(new JSONObject(stringWriter.toString())));
