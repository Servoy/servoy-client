 ...
 * @author jblok
 */
public class CmdReduceFind extends AbstractCmd
{
/*
 ...
 */
	public CmdReduceFind(ISmartClientApplication app)
	{
		super(
			app,
			"CmdReduceFind", app.getI18NMessage("servoy.menuitem.reduceSearch"), "servoy.menuitem.reduceSearch", app.getI18NMessage("servoy.menuitem.reduceSearch.mnemonic").charAt(0), app.loadImage("find_reduce.gif")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
