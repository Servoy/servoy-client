...
//		}
	...
	public static String getStyleCSS(String name) throws RepositoryException, RemoteException
	{
		...
		//default field stuff
		styleObj = css.addStyle(".field");//input, select, textarea"); 
		...
		switch (field.getDisplayType())
		{
			...
			case Field.RADIOS :
				...
				else
				{
					...
					html.append(">"); // 
					html.append("<table cellspacing='0' cellpadding='0' border='0' width='100%' height='100%'><tr><td id='check_td' style='vertical-align: middle;'><input style='border-width: 0px; padding: " +
...
//					html.append(getJavaScriptIDParameter(field));
	...
	private static void applyScrolling(TextualStyle styleObj, ISupportScrollbars field)
	{
		...
		styleObj.setProperty("overflow", overflow);
	}
