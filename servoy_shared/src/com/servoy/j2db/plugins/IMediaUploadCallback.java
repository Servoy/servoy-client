...
public interface IMediaUploadCallback
{
	 ...
	 * 
	 * @param fu The array of file data that are uploaded by the user.
	 */
	void uploadComplete(IUploadData[] fu);

	/**
	 * called when the submit button is pressed. It will be called after {@link #uploadComplete(IUploadData[])} if files were uploaded.
	 */
	void onSubmit();
