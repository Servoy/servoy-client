...
public class ServoyServerInMaintenanceMode extends WebPage
{
	...
	public ServoyServerInMaintenanceMode()
	{
	...
	protected void configureResponse()
	{
		...
		getWebRequestCycle().getWebResponse().getHttpServletResponse().setStatus(HttpServletResponse.SC_SERVICE_UNAVAILABLE); // better then HttpServletResponse.SC_NOT_FOUND; also used by cluster maintenance mode load balancer to avoid servers that are in maintenance mode
	}
