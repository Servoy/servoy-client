...
public class BaseQueryFactory implements IQueryFactory<IBaseSQLCondition, IBaseQuerySelectValue>
{
	...
	@Override
	public BaseQueryColumn createQueryColumn(BaseQueryTable table, String name, int sqlType, int length, int scale, int flags)
	{
		return new BaseQueryColumn(table, name, new BaseColumnType(sqlType, length, scale), null, flags, false);
	}
}
