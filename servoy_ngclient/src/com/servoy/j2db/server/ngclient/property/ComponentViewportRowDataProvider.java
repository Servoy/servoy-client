...
public class ComponentViewportRowDataProvider extends ViewportRowDataProvider
{
	...
	@Override
	protected void populateRowData(IRecordInternal record, String propertyName, JSONWriter w, DataConversion clientConversionInfo, String generatedRowId)
		throws JSONException
	{
		...
		{
			// full row
			componentTypeSabloValue.getRecordBasedProperties().forEach(propName -> populateCellData(propName, w, clientConversionInfo));
		}
		w.endObject();
	}
