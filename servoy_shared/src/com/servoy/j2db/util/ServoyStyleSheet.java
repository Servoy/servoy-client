...
public class ServoyStyleSheet implements IStyleSheet
{
	...
	public final static String[] BACKGROUND_IMAGE_CSS = new String[] { CSSName.BACKGROUND_ATTACHMENT.toString(), CSSName.BACKGROUND_IMAGE.toString(), CSSName.BACKGROUND_POSITION.toString(), CSSName.BACKGROUND_REPEAT.toString(), CSSName.BACKGROUND_SIZE.toString() };
