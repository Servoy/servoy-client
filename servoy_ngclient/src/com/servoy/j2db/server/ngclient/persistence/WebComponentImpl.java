 ...
 *
 */
public class WebComponentImpl extends WebComponent implements IWebComponent, IWebObject
{
	protected transient WebObjectImpl webObjectImpl;

	public WebComponentImpl(ISupportChilds parent, int element_id, UUID uuid)
	{
