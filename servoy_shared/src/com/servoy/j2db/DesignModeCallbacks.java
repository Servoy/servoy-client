...
public class DesignModeCallbacks
{
	...
	public Object executeOnDrag(JSEvent event)
	{
		if (ondrag != null)
		{
			return ondrag.execute((IClientPluginAccess)application.getPluginAccess(), new Object[] { event }, false);
		}
		return null;
	}
	...
	public Object executeOnDrop(JSEvent event)
	{
		if (ondrop != null)
		{
			return ondrop.execute((IClientPluginAccess)application.getPluginAccess(), new Object[] { event }, false);
		}
		return null;
	}
	...
	public Object executeOnSelect(JSEvent event)
	{
		if (onselect != null)
		{
			return onselect.execute((IClientPluginAccess)application.getPluginAccess(), new Object[] { event }, false);
		}
		return null;
	}
	...
	public Object executeOnResize(JSEvent event)
	{
		if (onresize != null)
		{
			return onresize.execute((IClientPluginAccess)application.getPluginAccess(), new Object[] { event }, false);
		}
		return null;
	}
