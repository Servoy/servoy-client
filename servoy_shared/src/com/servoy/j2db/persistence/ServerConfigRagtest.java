 ...
 *
 */
public class ServerConfigRagtest implements Serializable, Comparable<ServerConfigRagtest>
{
	...
	public ServerConfigRagtest(String serverName, String userName, String password, String serverUrl, Map<String, String> connectionProperties, String driver,
	...
	public ServerConfigRagtest getNamedCopy(String newServerName)
	{
		if (serverName.equals(newServerName)) return this;
		return new ServerConfigRagtest(newServerName, userName, password, serverUrl, connectionProperties, driver, catalog, schema, maxActive, maxIdle,
	...
	public ServerConfigRagtest getEnabledCopy(boolean newEnabled)
	{
		if (enabled == newEnabled) return this;
		return new ServerConfigRagtest(serverName, userName, password, serverUrl, connectionProperties, driver, catalog, schema, maxActive, maxIdle,
	...
	public int compareTo(ServerConfigRagtest sc)
	{
		if (sc == null) return -1;
	...
	public boolean equals(Object obj)
	{
		...
		ServerConfigRagtest other = (ServerConfigRagtest)obj;
		if (catalog == null)
		{
