...
public final class FormElement implements INGFormElement
{
	...
	{
		if ((form != null && !form.isResponsiveLayout()) || CSSPositionUtils.isInAbsoluteLayoutMode(getPersistIfAvailable()))
		{
...
//		}// end toRemove
	...
	Dimension getDesignSize()
	{
		...
		{
			return CSSPositionUtils.getSize((ISupportSize)persistImpl.getPersist());
		}
		return null;
	}
