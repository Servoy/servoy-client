...
/**
 * Constants used for anchoring elements.
 * 
 * @since 7.0
 * @author acostescu
 */
public interface ISMAnchor
{
	 ...
	 */
	public static final int NORTH = IAnchorConstants.NORTH;
	 ...
	 */
	public static final int EAST = IAnchorConstants.EAST;
	 ...
	 * stickToBottomRightCornerLabel.anchors = SM_ANCHOR.SOUTH | SM_ANCHOR.EAST;
	 */
	public static final int SOUTH = IAnchorConstants.SOUTH;
	 ...
	 * stickToTopLeftCornerLabel.anchors = SM_ANCHOR.NORTH | SM_ANCHOR.WEST;
	 */
	public static final int WEST = IAnchorConstants.WEST;
	 ...
	 */
	public static final int DEFAULT = IAnchorConstants.DEFAULT;
	 ...
	 */
	public static final int ALL = IAnchorConstants.ALL;
