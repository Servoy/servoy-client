...
public class JSSolutionModel
{
	...
	//newForm(String name, String serverName, String table_name, String styleName, boolean show_in_menu, int width, int height) <b>
	//newForm(String name, String dataSource, String styleName, boolean show_in_menu, int width, int height)
	//newForm(String name, JSForm toclonefrom)
	/**
