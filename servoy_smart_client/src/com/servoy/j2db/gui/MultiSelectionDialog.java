...
public class MultiSelectionDialog extends JEscapeDialog implements ActionListener
{
	...
	public MultiSelectionDialog(Dialog owner, String title, String message, String label1, String label2, Object[] entries, boolean[] isSelected,
	...
	public MultiSelectionDialog(Frame owner, String title, String message, String label1, String label2, Object[] entries, boolean[] isSelected,
		int[] targetListIndices, boolean hasUpDownButtons)
	{
		super(owner, true);
		init(entries, isSelected, targetListIndices, title, message, label1, label2, hasUpDownButtons);
	...
	public static int[] showDialog(Window window, String title, String msg, String label1, String label2, Object[] entries, boolean[] isSelected,
		int[] targetListIndices, boolean hasUpDownButtons)
	{
	...
	private void init(Object[] entries, boolean[] isSelected, int[] targetListIndices, String title, String message, String label1, String label2,
