...
public class CmdPrevRecord extends AbstractCmd
{
	public CmdPrevRecord(IApplication app)
	{
		super(
			app,
			"CmdPrevRecord", app.getI18NMessage("servoy.menuitem.previousRecord"), "servoy.menuitem.previousRecord", app.getI18NMessage("servoy.menuitem.previousRecord.mnemonic").charAt(0)/*
																																															 * ,app
																																															 * .
																																															 * loadImage
																																															 * (
