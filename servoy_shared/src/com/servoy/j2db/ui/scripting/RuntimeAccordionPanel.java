 ...
 * @since 6.0
 */
public class RuntimeAccordionPanel extends AbstractRuntimeFormContainer<ITabPanel, JComponent> implements IScriptAccordionPanelMethods
{
...
//				application.getSolution().getRelations(Solution.SOLUTION+Solution.MODULES, parentTable, true, false);
	...
	{
		return IScriptBaseMethods.ACCORDIONPANEL;
	}
