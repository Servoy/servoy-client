...
public class ClientPluginAccessProvider implements IClientPluginAccess
{
	...
	{
		Window window = application.getWindow(IFormManagerInternal.USER_WINDOW_PREFIX + application.getCurrentWindowName());
	...
	public Window getWindow(String windowName)
	{
		...
		Window window = application.getWindow(IFormManagerInternal.USER_WINDOW_PREFIX + windowName);
		if (window != null && window.isVisible())
		{
			return window;
		}
