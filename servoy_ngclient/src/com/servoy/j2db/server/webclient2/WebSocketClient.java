...
public class WebSocketClient extends ClientState implements IWebSocketApplication, IChangeListener
{
	private static final long serialVersionUID = 1L;

	private IWebSocketClientEndpoint activeWebSocketClientEndpoint;

	private IEventDispatcher<WebSocketEvent> executor;

	private transient volatile ServoyScheduledExecutor scheduledExecutorService;

	private transient IBeanManager beanManager;

	private WebSocketRuntimeWindowMananger runtimeWindowManager;

	private final Map<String, IService> services = new HashMap<>();

	public WebSocketClient(IWebSocketClientEndpoint webSocketClientEndpoint)
	{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.servoy.j2db.server.webclient2.IWebSocketApplication#getService(java.lang.String)
	 */
	@Override
	 ...
	 */
	@Override
	public IWebSocketFormManager getFormManager()
	{
		return (IWebSocketFormManager)super.getFormManager();
	}
	...
	public void setActiveWebSocketClientEndpoint(IWebSocketClientEndpoint activeWebSocketClientEndpoint)
	{
	 ...
	 */
	public IWebSocketClientEndpoint getActiveWebSocketClientEndpoint()
	{
	...
	{
		getEventDispatcher().addEvent(new WebSocketEvent(this, r));
	}
	...
	public void invokeAndWait(Runnable r)
	{
		...
		getEventDispatcher().addEvent(new WebSocketEvent(this, future));
		try
		{
			future.get(); // blocking
		}
	...
	{
		return new WebSocketFormManager(this);
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.servoy.j2db.server.webclient2.IWebSocketApplication#getChangeListener()
	 */
	@Override
	...
	@Override
	public WebSocketRuntimeWindowMananger getRuntimeWindowManager()
	{
		if (runtimeWindowManager == null)
		{
			runtimeWindowManager = new WebSocketRuntimeWindowMananger(this);
		}
	...
	public final synchronized IEventDispatcher<WebSocketEvent> getEventDispatcher()
	{
		if (executor == null)
		{
	 ...
	 */
	protected IEventDispatcher<WebSocketEvent> createDispatcher()
	{
		return new EventDispatcher<WebSocketEvent>(this);
	}
